...
export class RegistroPacienteComponent {
  ...
  registrarUsuario() {
      if (this.registroPacienteForm.valid) {
        ...
        this.usuario.nombre = this.registroPacienteForm.get('nombre')?.value || '';
        this.usuario.apellido = this.registroPacienteForm.get('apellido')?.value || '';
        ...
        this.authService.crearUsuario(this.registroPacienteForm.get('email')?.value || '', this.registroPacienteForm.get('repiteClave')?.value || '', this.usuario);
