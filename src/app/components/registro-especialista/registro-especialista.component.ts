...
export class RegistroEspecialistaComponent implements OnInit {
  ...
  onCheckboxChange(event: any, especialidad: string) {
    const especialidadesArray: FormControl = this.registroEspecialistaForm.get(
      'especialidades'
    ) as FormControl;
  ...
  registrarUsuario() {
    if (this.registroEspecialistaForm.valid) {
      ...
      this.usuario.nombre =
        this.registroEspecialistaForm.get('nombre')?.value || '';
      this.usuario.apellido =
        this.registroEspecialistaForm.get('apellido')?.value || '';
      this.usuario.edad =
        this.registroEspecialistaForm.get('edad')?.value || '';
      this.usuario.dni = this.registroEspecialistaForm.get('dni')?.value || '';
      this.usuario.obraSocial = '';
      this.usuario.especialidades =
        this.registroEspecialistaForm.get('especialidades')?.value || '';
      ...
      this.authService.crearUsuario(
        this.registroEspecialistaForm.get('email')?.value || '',
        this.registroEspecialistaForm.get('repiteClave')?.value || '',
        this.usuario
      );
